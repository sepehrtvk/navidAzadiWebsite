const staticTexts = {
  ...
  userPanel: {
    ...
    waitingPlan: {
      wait_plan: 'پکیج در انتظار تایید',
      wait_plan_desc:
        'پکیج شما با مشخصات زیر در سامانه ثبت شده و در انتظار تایید توسط مربی می باشد',
      plan_type: 'نوع پکیج',
      plan_time: 'مدت',
      plan_price: 'قیمت',
      one_year: 'یک‌ساله',
      six_month: 'شش‌ماهه',
      pay_desc:
        'لطفا مبلغ را به شماره کارت ۶۲۱۹۸۶۱۹۰۸۶۶۹۲۳۳ واریز نمایید و رسید آن را در واتس اپ به شماره ۰۹۱۲۰۵۳۲۱۲۱ ارسال نمایید',
    },
  },
  adminPanel: {
    title: 'پنل مدیریت',
